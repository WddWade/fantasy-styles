                ...
                <ul class="box_block_frame">
                    ...
                    <li class="inventory row_style tr_style">
                        ...
                        <div class="inner">
                            <div class="inner_box row_style">
                                <div class="info_text">
                                    <p class="title">是否收到審核通知信件</p>
                                    <p>打開開關，將會收到<strong>新增/編輯/刪除</strong>的審核通知信件
                                    </p>
                                </div>
                                <div class="switch_box">
                                    @if(isset($data['is_mail']))
                                    @if($data['is_mail'] == 1)
                                    <div class="ios_switch on mrg-l-30 ams_ios_switch">
                                        @else
                                        <div class="ios_switch mrg-l-30 ams_ios_switch">
                                            ...
                                            <div class="ios_switch on mrg-l-30 ams_ios_switch">
                                                @endif
                                                @if(isset($data['is_mail']))
                                                <input type="hidden" value="{{ $data['is_mail'] }}"
                                                    class="check_ams_rabio" name="amsData[is_mail]">
                                                @else
                                                <input type="hidden" value="1" class="check_ams_rabio"
                                                    name="amsData[is_mail]">
                                                @endif
                                                <input type="checkbox">
                                                <div class="box ams_switch_ball">
                                                    <span class="ball"></span>
