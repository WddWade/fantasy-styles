<li class="inventory row_style">
    ...
    <div class="inner">
        ...
        <div class="____select2MultiNew">
            <div class="select2_controllers">
                <a class="select2MultiNew_all" href="javascript:void(0)">
                    <span class="icon-check"></span>
                    <span>All</span>
                </a>
                <a class="select2MultiNew_unall" href="javascript:void(0)">
            ...
            <div class="select2MultiNew">
                ...
                <span data-id="{{ $val['key'] }}" draggable="true">
                    <a class="remove_selected">x</a>
                    {{ $val['title'] }}
                </span>
                @endforeach
            </div>
            <div class="select2MultiNew_dropdown">
