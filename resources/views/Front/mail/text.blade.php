                      ...
                      <tr>
                        <td>
                          ...
                          <table width="100%" border="0">
                            <tr>
                              <td align="center" style="padding-bottom: 20px;"><b style="font-size: 28px;font-weight: 600;letter-spacing: 1.2px"></b><b style="font-size:24px;">{{$data['title']}}</b></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
